...
function JobDetailsModal({ isOpen, onClose, job, onBack }: JobDetailsModalProps) {
  if (!job) return null;
        ...
        <div className="job-details-header">
          <div className="job-title-section">
            ...
            {job.matchScore !== undefined && (
              <span className={`job-match-score ${getMatchClass(job.matchScore)}`}>
          ...
          <div className="job-meta-grid">
            ...
            <div className="job-meta-card">
              ...
              <p style={{ textTransform: 'capitalize' }}>{job.experienceLevel}</p>
            </div>
          </div>
        </div>
